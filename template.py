...
def build_job_pack(facts: str, nde_result: str, wps_result: str, material: str) -> Union[Dict[str, Any], str]:
    ...
    if isinstance(facts, str):
        try:
            ...
            return facts # Not JSON → just return the raw string as-is
    ...
    #     output_lines.append(
    #         f"\nPrior to start of mechanical activities, perform wall thickness testing at {tp1} and {tp2}."
    #     )
    ...
    # if any(s in ["Valve replacement", "Clamp installation"] for s in facts["scope_type"]):
    #     output_lines.append("")
    ...
    #MVP2
    #output_lines.append("\nBP shall comply with TCO Guideline 16-0015-MI for socket-welded joints.”)
    #output_lines.append("\nBP shall comply with additional weld controls denoted in Closure Weld Package(s) CW-00-0YYY/00X.")
    #output_lines.append("\nNOTE: Do NOT drill the header or cut out nipo-flange coupons prior to hydro-testing branch connections.")
    ...
    #MVP2
    #output_lines.append("\nInstall civil structural support as per isometric drawing 00-YYYY-L-ZZZZ and attached Standard Support drawing.”)
    ...
    #MVP2
    #output_lines.append("\nBP shall comply with specified NDE requirements denoted in closure weld package(s) CW-00-0YYY/00X.”)
    ...
    #62 would be condition in MVP2 and line and line 64 is linked to it
    lines.append('62')
